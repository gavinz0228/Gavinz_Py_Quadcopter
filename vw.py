#!/usr/bin/env python
""" This module provides a 313MHz/434MHz radio interface compatible with 
the Virtual Wire library used on Arduinos. It has been tested between a 
Pi, TI Launchpad, and Arduino Pro Mini. """
# 2014-08-14 vw.py
import time 
import pigpio 
...
MIN_BPS=50 
MAX_BPS=10000 
HEADER=[0x2a, 0x2a, 0x2a, 0x2a, 0x2a, 0x2a, 0x38, 0x2c] 
_CTL=3 
_SYMBOL=[
